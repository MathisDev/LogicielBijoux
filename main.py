...
# ici --->	rqt = "SELECT * FROM Commandes;"
			...
			self.LabelCompte = tk.Label(self.topShowCommande,text=compte,bg=color1).place(x=320,y=135)
			self.titreCompte = tk.Label(self.topShowCommande,text='Compte poids : ',bg=color1).place(x=220,y=135)

			arbre = ttk.Treeview(self.topShowCommande,column=("c1", "c2", "c3","c4","c5","c6","c7","c8","c9","c10","c11","c12","c13","c14"), show='headings')
